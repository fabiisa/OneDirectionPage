// makes sure document is loaded before we try to access it
...
function addItemToCart(title, price, imageSrc) {
  ...
  var cartRowContents = `
    ...
    <div class="cart-quantity cart-colum">
        ...
        <button class="btn btn-primary btn-danger" role="button">REMOVE</button>
    </div>`
  cartRow.innerHTML = cartRowContents
  cartItems.append(cartRow)
  //adding the event listeners again since this portion of code 
  //was not originally part of the document
